      ...
      <div className={styles.mainDiv}>
        <div className={styles.mainDivCard}>
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/dentistry.png")}
              alt="Dentistry"
            />
          ...
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/primaryCare.png")}
              alt="Primary Care"
            />
          ...
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/cardiology.png")}
              alt="Cardiology"
            />
          ...
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/mriResonance.png")}
              alt="MRI Resonance"
            />
          ...
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/bloodTest.png")}
              alt="Blood Test"
            />
          ...
          <div className={styles.cardSpecialisation}>
            <img
              src={require("../../../assets/piscologist.png")}
              alt="Piscologist"
            />
