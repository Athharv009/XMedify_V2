            ...
            <div className={styles.rightSide}>
                <div className={styles.cardDivFirstCol}>
                    <div className={styles.happyPatientCard}>
                        <div>
                        <img src={require("../../../assets/happyPatients.png")} alt="Happy Patients" />
                        <h1>5000+</h1>
                        <p>Happy Patients</p>
                        </div>
                    </div>
                    <div className={styles.happyPatientCard}>
                        <div>
                        <img src={require("../../../assets/labrotaries.png")} alt="Laboratories" />
                        <h1>1000+</h1>
                        <p>Laboratories</p>
                        </div>
                    </div>
                ...
                <div className={styles.cardDivSecondCol}>
                    <div className={styles.happyPatientCard}>
                        <div>
                        <img src={require("../../../assets/hospitals.png")} alt="Hospitals" />
                        <h1>200+</h1>
                        <p>Hospitals</p>
                        </div>
                    </div>
                    <div className={styles.happyPatientCard}>
                        <div>
                        <img src={require("../../../assets/expertDoctors.png")} alt="Expert Doctors" />
                        <h1>700+</h1>
                        <p>Expert Doctors</p>
                        </div>
                    </div>
